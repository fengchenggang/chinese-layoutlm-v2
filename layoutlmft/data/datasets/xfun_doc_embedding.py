...
class XFUN(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, filepaths):
        filepaths = [['/work/Codes/layoutlmft/gartner-data/zh.test.json',
                      '/work/Codes/layoutlmft/gartner-data/zh.test']]
        for filepath in filepaths:
            ...
            train_data = [(item[0], item[1], label2id[item[2]]) for item in train_data]
